...
import volkiharSlidePlaceholder from './assets/volkihar-slide-placeholder.jpg'; from './assets/volkihar-enderal-logo-large.png';
import volkiharEnderalLogoPlaceholder from './assets/volkihar-enderal-logo-placeholder.png';
import volkiharEnderalLogoPlaceholder from './assets/volkihar-enderal-logo-placeholder.png';
...
export function VolkiharKnight() {
  return (
    <Fragment>
      ...
      <ProjectContainer>
        <ProjectBackground
          srcSet={[volkiharBackground]}
          placeholder={volkiharBackground}
          opacity={0.5}
        />
        <ProjectHeader
          title={title}
        ...
        <ProjectSection>
          <ProjectSectionContent>
            <ProjectImage
              srcSet={[volkiharBanner]}
              placeholder={volkiharBanner}
        ...
        <ProjectSection
          backgroundElement={
            <Image
              srcSet={[volkiharEnderal]}
              placeholder={volkiharEnderal}
